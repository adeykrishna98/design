(function($) {
    ...
    /**
      ...
      */
      ...
      // second animation
        ...
        $isAnimatedThird.eq(0).addClass('animated fadeInUpBig').css('animation-delay', '.3s'); 
      ...
      */
      ...
      // third animation
        ...
        $isAnimatedFourth.addClass('animated fadeInUpBig').css('animation-delay', '.6s');
  ...
  $('#showcase_batn_text_explore').on('click', function(){
